...
def build_graph() -> tuple[list[dict[str, Any]], list[dict[str, Any]]]:
    objects = [
        ...
        obj("personnel:wang_lei", "personnel", "王磊（项目经理，Mock）", default_unit_cost=money(1_200)),
        obj("personnel:delivery_team", "personnel", "智慧园区交付组（Mock）", default_unit_cost=money(900)),
        obj("personnel:data_team", "personnel", "工业数据实施组（Mock）", default_unit_cost=money(1_100)),
        obj("software:workflow", "software_resource", "流程编排平台许可（Mock）", default_unit_cost=money(6_000)),
        obj("software:digital_twin", "software_resource", "工业数字孪生平台许可（Mock）", default_unit_cost=money(15_000)),
        obj("hardware:edge_cluster", "hardware_resource", "边缘计算服务器组（Mock）", default_unit_cost=money(4_500)),
        obj("hardware:inspection_tablets", "hardware_resource", "巡检平板设备组（Mock）", default_unit_cost=money(500)),
    ...
    relations = [
        ...
        rel("rel:wang:inspection", "allocated_to", "personnel:wang_lei", "order:park_inspection", quantity=45, unit="person_day", cost_amount=money(54_000), start_date="2026-03-15", end_date="2026-05-31"),
        rel("rel:delivery_team:inspection", "allocated_to", "personnel:delivery_team", "order:park_inspection", quantity=180, unit="person_day", cost_amount=money(162_000), start_date="2026-03-20", end_date="2026-06-15"),
        rel("rel:workflow:inspection", "allocated_to", "software:workflow", "order:park_inspection", quantity=6, unit="license_month", cost_amount=money(36_000), start_date="2026-03-15", end_date="2026-09-14"),
        rel("rel:edge:optimization", "allocated_to", "hardware:edge_cluster", "order:park_optimization", quantity=4, unit="device_month", cost_amount=money(18_000), start_date="2026-06-01", end_date="2026-09-30"),
        rel("rel:wang:data_platform", "allocated_to", "personnel:wang_lei", "work_item:data_platform", quantity=30, unit="person_day", cost_amount=money(36_000), start_date="2026-06-01", end_date="2026-07-31"),
        rel("rel:data_team:data_platform", "allocated_to", "personnel:data_team", "work_item:data_platform", quantity=240, unit="person_day", cost_amount=money(264_000), start_date="2026-05-20", end_date="2026-09-30"),
        rel("rel:digital_twin:data_platform", "allocated_to", "software:digital_twin", "work_item:data_platform", quantity=12, unit="license_month", cost_amount=money(180_000), start_date="2026-05-20", end_date="2027-05-19"),
        rel("rel:edge:data_platform", "allocated_to", "hardware:edge_cluster", "work_item:data_platform", quantity=6, unit="device_month", cost_amount=money(27_000), start_date="2026-05-20", end_date="2026-11-19"),
        rel("rel:workflow:maintenance", "allocated_to", "software:workflow", "work_item:predictive_maintenance", quantity=4, unit="license_month", cost_amount=money(24_000), start_date="2026-07-01", end_date="2026-10-31"),
        rel("rel:tablets:maintenance", "allocated_to", "hardware:inspection_tablets", "work_item:predictive_maintenance", quantity=10, unit="device_month", cost_amount=money(5_000), start_date="2026-07-01", end_date="2026-10-31"),
